...
export default function Cadastro() {
    ...
    const handleConfirmPasswordChange = (
        newPassword2: SetStateAction<string>
    ) => {
        ...
        <section className="h-screen">
            ...
            <div className="container h-full px-6 py-24">
                <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between ">
                    <div
                        className="flex flex-col justify-center items-center mb-12 md:mb-0 md:w-8/12 lg:w-6/12 sm:block hidden">
                    ...
                    <div className="md:w-8/12 lg:ml-6 lg:w-5/12 h-max">
                        <form onSubmit={handleRegister}>
                            ...
                            <FormularioCadastro
                                ...
                                onChangeUser={handleUsernameChange}
                            />
                            <div className="relative mb-6" data-te-input-wrapper-init="">
                                ...
                                <ExibirSenha
                                    inputId={"password2"}
                                    inputLabelName={"Confirmar senha"}
