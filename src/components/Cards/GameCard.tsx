...
const GameCard: React.FC<GameCardProps> = ({ game }) => {
  return (
    <div className="relative rounded-lg border border-gray-300 p-2 md:p-4 w-full md:w-48 mx-auto my-2 md:mx-4 md:my-4 md:flex">
      ...
      <div className="relative md:w-60">
        ...
        <div className="flex justify-center mt-4">
          <button className="bg-gray-500 text-white text-sm px-2 py-1 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
            Veja mais
          </button>
        </div>
      </div>
