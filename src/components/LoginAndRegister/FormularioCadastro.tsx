...
const FormularioCadastro: React.FC<FormularioCadastroProps> = ({
  ...
  const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (onChangeName) {
      ...
      console.warn(
        "Você precisa passar a prop onChangeName para o componente FormularioCadastro"
      );
    }
  };
  ...
  const handleUserChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (onChangeUser) {
      ...
      console.warn(
        "Você precisa passar a prop onChangeUser para o componente FormularioCadastro"
      );
    }
  };
